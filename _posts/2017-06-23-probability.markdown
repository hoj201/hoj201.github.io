...
the second box has contextual clues, which hint at what is meant.
Probability theory relies heavily on contextual clues, in order to compensate
for it's awful notation.
