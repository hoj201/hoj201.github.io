...
![coin flip](https://media.giphy.com/media/5EQC8eAnEAAZG/giphy.gif)
...
![a ray in $$\mathbb{R}^2$$](image address)
...
![the end](https://media.giphy.com/media/APHFMUIaTnLIA/giphy.gif)
